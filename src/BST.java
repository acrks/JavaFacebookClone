...
public class BST<T> {
    ...
    public T getRoot() throws NoSuchElementException {
        if(isEmpty()){
            throw new NoSuchElementException("Can't return root's data. Tree is empty.");
        }
        return root.data;
    }
    ...
    public T findMin() throws NoSuchElementException {
        if(!isEmpty()){
            throw new NoSuchElementException("findMin cant find min. Tree is empty.");
        }
        return findMin(root);
    }
    ...
    public T findMax() throws NoSuchElementException {
        if(isEmpty()){
            throw new NoSuchElementException("findMax cant find max. Tree is empty.");
        }
        return findMax(root);	}
